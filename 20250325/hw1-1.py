...
def plot_cash_exchange_rate(file_path):
    try:
        ...
        # 過濾出日期格式的資料
        df = df[df['資料日期'].str.match(r'^\d{8}$', na=False)]
...
if __name__ == "__main__":
    # 使用原始字串格式避免路徑問題
    csv_file_path = r"C:\Users\User\Desktop\cycu_oop_11372006\Exc0325.csv"
    plot_cash_exchange_rate(csv_file_path)